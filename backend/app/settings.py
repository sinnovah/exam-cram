...
SECRET_KEY = 'django-insecure-b+g)un2r9b6sxmx_^5hh6%nlx!91&tqnvfpc@5%#m$_at+-50m'
...
MIDDLEWARE = [
    'app.middleware.replace_server_in_header.ReplaceServerHeaderMiddleware',
...
# Database configured with environment variables from docker-compose.yml
